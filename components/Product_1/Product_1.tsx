...
const Product_1: FunctionComponent<{
  ...
  return (
    <Link href={productId} passHref>
      <div className="p-[20px] bg-white box-border max-w-[300px] flex flex-col rounded hover:drop-shadow-lg cursor-pointer group transition duration-200 border-[0.1px] font-poppins">
        <div>
        ...
        <div className="my-[20px] max-w-[285px]">
          <p className="text-[14px] font-normal group-hover:text-[#F96800] transition-colors">
